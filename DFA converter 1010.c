...
void print_transition_table() {
    printf("DFA Transition Table for Regular Expression: (0|1)*01\n");
    printf("====================================================\n");
    printf("| State | '0' (0) | '1' (1) | Final? |\n");
    printf("|-------|---------|---------|--------|\n");
...
bool check_string_against_dfa(const char *input) {
    ...
    for (int i = 0; i < strlen(input); i++) {
        ...
        if (symbol == '0') {
            ...
            printf("Error: Invalid symbol '%c' encountered. Only '0' and '1' allowed.\n", symbol);
            return false;
        }
...
int main() {
    ...
    check_string_against_dfa("1101");
    printf("\n");
    check_string_against_dfa("111");
    printf("\n");
    check_string_against_dfa("0001");
